...
//		$adb->pquery("INSERT INTO vtiger_profile VALUES ('".$profileId4."','Guest Profile','Guest Profile for Test Users')", array());
	...
	$vendorsInstance->addLink('DETAILVIEWBASIC', 'LBL_VENDORS_ADD_EVENT', 'index.php?module=Calendar&view=Edit&mode=Events&sourceModule=Vendors&sourceRecord=$RECORD$&relationOperation=true&parent_id=$RECORD$','themes/images/AddEvent.gif');
	$vendorsInstance->addLink('DETAILVIEWBASIC', 'LBL_VENDORS_ADD_TASK', 'index.php?module=Calendar&view=Edit&mode=Calendar&sourceModule=Vendors&sourceRecord=$RECORD$&relationOperation=true&parent_id=$RECORD$','themes/images/AddToDo.gif');
