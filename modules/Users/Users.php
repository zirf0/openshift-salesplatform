...
//        $this->db->startTransaction();
    ...
    function retrieve_entity_info($record, $module) {
		...
		if($this->column_fields['currency_grouping_pattern'] == ''
			 ...
			 //SalesPlatform.ru begin
                        $this->column_fields['currency_grouping_pattern'] = $this->currency_grouping_pattern = '123456789';
	...
	public static function getPackagesList() {
		$restrictedModulesList = array('Emails', 'ModComments', 'Rss', 'Portal', 'Integration',
			...
			'Sales' => array(
				...
				'description' => 'Выявление потенциальных клиентов с вашего сайта и импорт в CRM. Анализ собранных данных и создание потенциальных возможностей для продаж.',
				'modules' => array(
					'Potentials' => 'Сделки',
                                        'Leads' => 'Обращения',
			...
			'Marketing' => array(
				...
				'description' => 'Рассылка сообщений по вашему списку контактов, привлечение потенциальных покупателей и клиентов, инструменты для анализа и повышения эффективности работы кампании.',
				'modules' => array(
                                        'Campaigns' => 'Кампании'
                                )),
			...
			'Support' => array(
				...
				'description' => 'Создание и отслеживание клиентских заявок. Также позволяет содавать и просматривать клиентам свои заявки через клиентский портал.',
				'modules' => array(
					'HelpDesk' => 'Заявки',
			...
			'Inventory' => array(
				...
				'description' => 'Создание базы данных продуктов, услуг, товаров, создание каталогов, использование этих данных для создания предложений, счетов и заказов.',
				'modules' => array(
					'Quotes' => 'Предложения',
					'Invoice' => 'Счета',
					'SalesOrder' => 'Заказы',
			...
			'Project' => array(
				...
				'description' => 'Создание и управление проектами и проектными задачами заказчика, которые могут быть назначены пользователю CRM и отмечены в его календаре.',
				'modules' => array(
					'Project' => 'Проекты',
