...
$unWanted=array(
 ...
 // SalesPlatform.ru begin Delete wrong SMS provider
 "modules/SMSNotifier/providers/SMSProvider.php"
 // SalesPlatform.ru end
);
...
if(!defined('INSTALLATION_MODE')) {
    ...
    if(!$moduleInstance){ 
       ...
       installVtlibModule('PBXManager', 'packages/vtiger/mandatory/PBXManager.zip'); 
        ...
        $pbxAllCustomViewId = $adb->query_result($result, 0, 'cvid');
...
// SalesPlatform.ru begin Update logo image
Migration_Index_View::ExecuteQuery("UPDATE vtiger_organizationdetails SET logoname = ?;", array('vtiger-crm-logo.png')); 
// SalesPlatform.ru end
