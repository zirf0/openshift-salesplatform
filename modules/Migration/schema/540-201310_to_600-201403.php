...
//SalesPlatform.ru begin
$dayOfTheWeek->defaultvalue = 'Monday';
...
$result = $adb->pquery('SELECT linkid FROM vtiger_links WHERE vtiger_links.linklabel IN (?,?,?,?,?) '
        . 'AND vtiger_links.linktype=? AND vtiger_links.tabid=?;',
        array("History", "Funnel", "Upcoming Activities", "Overdue Activities", "Tag Cloud", "DASHBOARDWIDGET", $moduleId));
...
// SalesPlatform.ru begin SP modules changes
