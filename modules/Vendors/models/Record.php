...
class Vendors_Record_Model extends Vtiger_Record_Model {
	...
	function getCreatePurchaseOrderUrl() {
		...
		return "index.php?module=".$purchaseOrderModuleModel->getName()."&view=".$purchaseOrderModuleModel->getEditViewName()."&sourceModule=Vendors&sourceRecord=".$this->getId()."&relationOperation=true&vendor_id=".$this->getId();
