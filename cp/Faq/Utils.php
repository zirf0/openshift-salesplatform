...
function getSearchCombo()
{
	...
	$comboarray .= '<OPTION value="all:All">'.getTranslatedString('All').'</OPTION>';
	$comboarray .= '<OPTGROUP label='.getTranslatedString('Categories').'>';
	...
	$comboarray .= '</OPTGROUP>';
    // SalesPlatform.ru begin localization
    $comboarray .= '<OPTGROUP label='.getTranslatedString('Products').'>';
