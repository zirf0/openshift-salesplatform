...
<html class="bg-gray">
	<head>
		<title><?php echo getTranslatedString('customerportal');?></title>
	...
	<body class="bg-gray">
		<div class="form-box" id="login-box">
    		<div class="header" style="font-weight: 400;"><?php echo getTranslatedString('customerportal');?></div>
      		<form name="login" action="CustomerAuthenticate.php" method="post">
				...
				<div class="footer" >
                    ...
                    <span class="text-center" style="font-size:14px;"><?php  echo getTranslatedString('LBL_LOGIN_NOTE');?></span>
            	</div>
			</form>
        </div>
	<center><div style="margin-top: 20px;">&#169 2004-<?=date('Y')?>&nbsp; <a href="https://www.vtiger.com"> vtiger.com</a> | &nbsp;&#169 2011-<?=date('Y')?>&nbsp; <a href="http://salesplatform.ru/"> SalesPlatform.ru</a></div></center>
	</body>
</html>
