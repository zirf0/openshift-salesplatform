...
function getblock_fieldlist($block_array)
{
	...
	if($field_count != 0)
	{
		...
		for($i=0;$i<$field_count;$i++,$z++)
		{
            ...
            // SalesPlatform.ru begin localization
            if($block_array[$i]['fieldlabel'] == 'Акцизный сбор' ||
                $block_array[$i]['fieldlabel'] == 'Комиссия' ||
                $block_array[$i]['fieldlabel'] == 'Курс' ||
                $block_array[$i]['fieldlabel'] == 'Индивидуальный налог' ||
                $block_array[$i]['fieldlabel'] == 'Получен' ||
                $block_array[$i]['fieldlabel'] == 'Баланс' ||
                $block_array[$i]['fieldlabel'] == 'Годовой доход'){
